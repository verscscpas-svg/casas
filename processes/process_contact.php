...
// --------------------
$recaptchaSecret = "6LdzUGYsAAAAAEaLq4qxUIHT-I-VNM1jE69Nckrw"; // your secret key
...
$response = file_get_contents($verifyURL . "?secret={$recaptchaSecret}&response={$recaptchaResponse}&remoteip={$userIP}");
...
<img src="cid:company_logo" alt="Company Logo" style="max-height:60px"/>
<h2 style="color:#ffffff; margin:10px 0 0">CASAS SAN LUIS & CO.</h2>
</td>
</tr>
<tr>
...
<tr><td style="background:#f9fafb;border:1px solid #e5e7eb;font-weight:bold; vertical-align:top;">Message</td><td style="border:1px solid #e5e7eb;width:100%;">' . $message . '</td></tr>
</table>
</td>
</tr>
<tr>
<td style="background:#f9fafb;padding:15px;text-align:center;font-size:12px;color:#6b7280;">
This message was sent from your website contact form.<br/>© ' . date('Y') . ' Casas San Luis & Co
</td>
</tr>
</table>
</td></tr></table>
